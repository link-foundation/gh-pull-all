...
async function testFastIntegration() {
  ...
  try {
    ...
    if (
      noArgsResult.output.includes('No valid GitHub user or organization was provided') &&
      noArgsResult.output.includes('Use --user <name> or --org <name>')
    ) {
      log('green', '✅ Argument validation: Auto-detection rejects missing owner in non-repo directories')
    } else {
